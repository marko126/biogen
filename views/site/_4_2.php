<div class="category-item slide-4-2">
    <div class="col-lg-8 slide-part-left">
        <div>
            <img src="<?= Yii::getAlias('@web') . '/images/categories/4-2-1.png' ?>" />
        </div>
        <ul>
            <li>To eller flere Attakker</li>
            <li>Varighed mindst 24 timer</li>
            <li>Mindst en måned imellem</li>
            <li>Symptomer forskellige steder på kroppen</li>
