...
//use Yii;
?>
<div class="category-item slide-0-1">
    <div class="category-menu-item col-lg-3 cat-1">
    ...
    <div class="category-menu-item col-lg-3 cat-2">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-3">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-4">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-5">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-6">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-7">
            <div class="category-menu-item-container">
    ...
    <div class="category-menu-item col-lg-3 cat-8">
            <div class="category-menu-item-container">
