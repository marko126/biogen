...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <div class="row">
		<?php echo $form->labelEx($model,'extra_points_min'); ?>
		<?php echo $form->textField($model,'extra_points_min'); ?>
		<?php echo $form->error($model,'extra_points_min'); ?>
	</div>

        <div class="row">
		<?php echo $form->labelEx($model,'extra_points_max'); ?>
		<?php echo $form->textField($model,'extra_points_max'); ?>
		<?php echo $form->error($model,'extra_points_max'); ?>
	</div>
