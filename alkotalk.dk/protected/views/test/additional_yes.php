    ...
    <div class="form-column-half">    
        <?php 
            foreach ($answers as $answer) {
                ...
                echo (($i == 1 && $j == 9) || ($i == 5 && $j == 9)) ? CHtml::textArea('answer_text['.$answer->id.']', '', ['disabled' => 'disabled']) : '';
...
<?php if (in_array($i, array(3, 4))) { ?>
<div class="w100 tal">
    <div class="question-title">
        <p>Må vi kontakte dig senere for at høre om dine alkoholvaner?</p>
        <p>Indtast mail eller tlf.</p>
        <?php echo Chtml::textField('Test[email_phone]['.$i.']') ?>
    </div>
</div>
<?php } ?>
                                                            
<?php if (in_array($i, array(1, 3, 4))) { ?>
<div class="w100 tar">
